...
## Data availability
Raw data with labelled subgroups (treatment/condition columns) can be found in the GitHub repository folder "raw_data".
Data are stored in four *.txt files. [Here is the direct link](https://github.com/mytalbot/RELSA/tree/master/raw_data). 
The data in the file "tm_post-op.txt" is also internalized in the RELSA package and can be called with: `RELSA::postop`. 
