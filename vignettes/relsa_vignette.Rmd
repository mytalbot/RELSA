...
## Working example
Provide a path and textfile with the reference and testset.  
Example data can be downloaded here: Download example data.
...
raw          <- relsa_load("path/filename.txt", treatment = "Transmitter" )
...
testraw      <- relsa_load("path/filename.txt", treatment = "Transmitter" )
