...
1. The score provides a metric for direct comparison within relative context.
...
```{r echo=FALSE}
plot( c(-1:28), relsascore,  type="b", pch=19, col="red", xlim=c(-1,28), ylim=c(0,1.2), xlab="day", ylab="RELSA score" )
