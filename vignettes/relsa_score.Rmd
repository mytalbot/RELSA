...
plotset       <- relsa_plot(pre_test, RELSA, levels=levels, animal=animal, plotvar=NULL,
                            plotRELSA=TRUE, myylim=c(80,120), myYlim=c(0,1.2), mypch=19)
lines(-1:28, relsascore2, type="b", pch=19)
...
legend("topright",c("Transmitter/Carprofen","Sham/Carprofen"), col=c("red","black"), bty="n", pch=c(19,19), lty=c(1,1))
